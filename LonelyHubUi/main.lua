if (game:GetService("CoreGui")):FindFirstChild("Lonely") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).Lonely:Destroy();
...
ImageButton1.Image = "rbxassetid://112485471724320"
ImageButton1.MouseButton1Down:connect(function()
    (game.CoreGui:FindFirstChild("Lonely")).Enabled = not (game.CoreGui:FindFirstChild("Lonely")).Enabled;
    sound:Play()
end)
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Lonely") then
			makefolder("Lonely");
		end;
		if not isfolder("Lonely/Library/") then
			makefolder("Lonely/Library/");
		end;
		if not isfile(("Lonely/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Lonely/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Lonely/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Lonely/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Lonely/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function ChiuMyLy:Window(Config)
	...
	local Lonely = Instance.new("ScreenGui");
	Lonely.Name = "Lonely Hub";
	Lonely.Parent = game.CoreGui;
	Lonely.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = Lonely;
